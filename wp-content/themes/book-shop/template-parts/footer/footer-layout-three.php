<footer class="<?php 
            ...
            <div class="amberd-footer-copyright-text">
                ...
                $amberdFooterWP = sprintf( esc_html__( ' %s Powered by WordPress.', 'book-shop' ), '<a target="_blank" title="WordPress Book Shop Theme" href="'. esc_url( 'https://wordpress.org/themes/book-shop' ) .'">Book Shop</a> Theme.' );
                ?>
